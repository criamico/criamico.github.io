            ...
            places = [
                {
                    ...
                    'description': '<h3>Catania, Italy</h3><ul><li><img src="img/Università_di_Catania_logo.jpg"><h4>2007-2010 University of Catania</h4><p>Ma, Automation engineering</p></li><li><img src="img/Università_di_Catania_logo.jpg"><h4>2002-2006 University of Catania</h4><p>Ba, Electronic engineering</p></li></ul>',
                },
                {
                    'coord': {lat: 45.068133, lng: 7.683158},
                    'image': 'img/pin-grey.png',
                    'description': '<h3>Torino, Italy</h3><ul><li><img src="img/Actia.jpg"><h4>2011-2012 ACTIA Italia S.r.L.</h4><p>Software Developer</p></li><li><img src="img/Cnh_industrial_logo.jpg"><h4>2010-2011 CNH Industrial (formerly Iveco S.p.A.)</h4><p>Electronic Systems Engineer</p></li></ul>',
                },
                {
                    'coord': {lat: 42.655697, lng: -83.233414},
                    'image': 'img/pin-grey.png',
                    'description': '<h3>Auburn Hills, MI, USA</h3><ul><li><img src="img/fca_logo.jpg"><h4>2013-2015 FCA North America (formerly Chrysler LLC)</h4><p>UI Software Developer</p></li></ul>',
